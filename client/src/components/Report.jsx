  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h2 className="text-xl font-semibold text-[#0f172a]">Autonomous Recovery Report</h2>
          <p className="text-sm text-slate-500 mt-0.5">Comprehensive audit metrics and category conversion efficiency</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <div className="p-4 bg-white border border-slate-200 rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
          ...
          <div className="mt-2 text-2xl font-bold text-[#0052ff] font-mono">
